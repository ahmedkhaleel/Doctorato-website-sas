...
// Local in-flight guard — see DemoRequestForm.vue for the same fix.
// captcha.execute() takes 50-500ms during which form.processing is
// still false, so a double-click would fire submitForm twice and
// create two ContactMessage rows. The guard blocks the second call.
