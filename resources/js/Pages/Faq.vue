    ...
    <MainLayout>
        ...
        <section class="py-20 bg-gradient-to-b from-gray-50 to-white">
            <div class="max-w-3xl mx-auto px-4 text-center">
                <div class="bg-white rounded-3xl border border-gray-100 shadow-lg p-10 md:p-14 animate-fade-up">
                    <div class="w-14 h-14 rounded-2xl bg-[#1B4F72]/10 flex items-center justify-center mx-auto mb-6">
                    ...
                    <h2 class="text-2xl md:text-3xl font-extrabold text-[#1C2833] mb-4">
                        {{ t('faq.cta_title') || 'لم تجد إجابة لسؤالك؟' }}
                    </h2>
                    <p class="text-gray-500 mb-8 leading-relaxed">
                        {{ t('faq.cta_desc') || 'تواصل معنا وسنرد عليك في أقرب وقت' }}
                    </p>
                    <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                        ...
                        >
                            ...
                            {{ t('faq.cta_contact') || 'تواصل معنا' }}
                        </a>
                        <a
                            href="/demo"
                            class="inline-flex items-center gap-2 px-8 py-3.5 border-2 border-[#1B4F72] text-[#1B4F72] font-semibold rounded-xl hover:bg-[#1B4F72] hover:text-white transition-all duration-300"
                        >
                            {{ t('faq.cta_demo') || 'اطلب عرضاً تجريبياً' }}
                        </a>
                    </div>
                </div>
            </div>
