            ...
            <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                    <article v-for="(item, i) in [
                        ...
                        { icon: '🏥', titleAr: '7 تخصصات طبية', titleEn: '7 medical specialties', bodyAr: 'أسنان، جلدية، أطفال، نساء، باطنة، تليميديسن، نفسية وعصبية — قوالب جاهزة لكل تخصص.', bodyEn: 'Dental, derma, pediatrics, OB-GYN, internal medicine, telemedicine, psychiatry & neurology — templates per specialty.' },
