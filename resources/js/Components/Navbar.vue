...
const navLinks = computed(() => [
    { label: t('nav.home'), href: '/' },
    {
        ...
        children: [
            ...
            { label: locale.value === 'ar' ? 'الجلدية والتجميل' : 'Dermatology & Cosmetics', href: '/dermatology', desc: locale.value === 'ar' ? 'صور قبل/بعد، باقات جلسات، موافقات رقمية، ومخزون منتجات' : 'Before/after photos, session packages, digital consents, product inventory', icon: 'derma' },
            { label: locale.value === 'ar' ? 'نظام عيادات الأسنان' : 'Dental Clinic System', href: '/dental', desc: locale.value === 'ar' ? 'نظام متكامل لإدارة عيادات الأسنان بمعايير FDI' : 'Complete dental clinic system with FDI standards', icon: 'dental' },
            ...
            { label: locale.value === 'ar' ? 'الاستشارات الأون لاين' : 'Online Consultations', href: '/telemedicine', desc: locale.value === 'ar' ? 'مكالمات فيديو HD + وصفات إلكترونية + دفع فوري' : 'HD video + e-prescriptions + instant billing', icon: 'telemedicine' },
            { label: locale.value === 'ar' ? 'النساء والتوليد' : 'Obstetrics & Gynecology', href: '/obstetrics', desc: locale.value === 'ar' ? 'متابعة الحمل WHO، سونار، Pap Smear، تنظيم الأسرة، بوابة المريضة' : 'WHO antenatal care, ultrasound, Pap smear, family planning, patient portal', icon: 'obstetrics' },
            { label: locale.value === 'ar' ? 'الطب النفسي والعصبي' : 'Psychiatry & Neurology', href: '/psychiatry', desc: locale.value === 'ar' ? 'فحص MSE، PHQ-9 / GAD-7 / MoCA، سجل أدوية مراقَبة، EEG/EMG، وتتبّع المزاج' : 'MSE, PHQ-9 / GAD-7 / MoCA, controlled-substance log, EEG/EMG, mood tracking', icon: 'psychiatry' },
                                        ...
                                        >
                                            <div class="w-10 h-10 rounded-xl bg-primary/5 group-hover:bg-primary/10 flex items-center justify-center shrink-0 transition-colors">
                                                <svg class="w-5 h-5 text-primary" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
                                                    ...
                                                    <path v-else-if="child.icon === 'derma'" stroke-linecap="round" stroke-linejoin="round" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z"/>
                                                    ...
                                                    <path v-else-if="child.icon === 'telemedicine'" stroke-linecap="round" stroke-linejoin="round" d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z"/>
                                                    <path v-else-if="child.icon === 'obstetrics'" stroke-linecap="round" stroke-linejoin="round" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"/>
                                                    <path v-else-if="child.icon === 'psychiatry'" stroke-linecap="round" stroke-linejoin="round" d="M12 11c0 3.517-1.009 6.799-2.753 9.571m-3.44-2.04l.054-.09A13.916 13.916 0 008 11a4 4 0 118 0c0 1.017-.07 2.019-.203 3m-2.118 6.844A21.88 21.88 0 0015.171 17m3.839 1.132c.645-2.266.99-4.659.99-7.132A8 8 0 008 4.07M3 15.364c.64-1.319 1-2.8 1-4.364 0-1.457.39-2.823 1.07-4"/>
