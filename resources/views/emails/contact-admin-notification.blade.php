                ...
                <table width="640" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:14px;overflow:hidden;box-shadow:0 6px 24px rgba(13,43,69,0.06);">
                    ...
                    <tr>
                        <td style="background:#0A1628;padding:18px 24px;">
                            <table width="100%"><tr>
                                ...
                                <td align="left" style="font-size:11px;color:rgba(255,255,255,0.45);">{{ $contact->created_at->format('Y-m-d H:i') }}</td>
                            </tr></table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:24px 24px 12px;">
                            <h2 style="font-size:20px;margin:0 0 4px;color:#1C2833;">{{ $contact->name }}</h2>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                                <tr>
                                    ...
                                    <td style="padding:10px 0;border-top:1px solid #EEF2F6;font-size:13px;color:#1C2833;font-weight:600;">{{ $contact->subject }}</td>
                                </tr>
                                <tr>
                                    <td style="padding:10px 0;border-top:1px solid #EEF2F6;font-size:12px;color:#8B9BAC;vertical-align:top;">الرسالة</td>
                                    <td style="padding:10px 0;border-top:1px solid #EEF2F6;font-size:13px;color:#1C2833;line-height:1.7;white-space:pre-wrap;">{{ $contact->message }}</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                            ...
                            <table cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="padding:0 6px 0 0;">
                                        <a href="mailto:{{ $contact->email }}" style="display:inline-block;padding:10px 20px;background:#C4A265;color:#fff;text-decoration:none;font-size:13px;font-weight:700;border-radius:8px;">رد بالبريد</a>
                                    </td>
                                    @if($contact->phone)
                                    <td style="padding:0 6px 0 0;">
                                        <a href="https://wa.me/{{ preg_replace('/\D/', '', $contact->phone) }}" style="display:inline-block;padding:10px 20px;background:#25D366;color:#fff;text-decoration:none;font-size:13px;font-weight:700;border-radius:8px;">واتساب</a>
                                    </td>
                                    @endif
                                    <td>
                                        <a href="https://doctorato.com/admin/contact-messages/{{ $contact->id }}" style="display:inline-block;padding:10px 20px;background:#F4F6F8;color:#5A6C7D;text-decoration:none;font-size:13px;font-weight:700;border-radius:8px;">فتح في الـ Admin</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
