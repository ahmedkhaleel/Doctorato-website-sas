    ...
    public function run(): void
    {
        $faqs = [
            ...
            [
                ...
                'answer_ar' => 'نقبل الدفع عبر: بطاقات الائتمان (Visa, Mastercard, Mada)، فوري، ميزة، التحويل البنكي المباشر، وApple Pay. يمكنك اختيار الاشتراك الشهري أو السنوي. الاشتراك السنوي يوفّر لك شهرين كاملين (تدفع 10 شهور بدل 12).',
                'answer_en' => 'We accept: credit cards (Visa, Mastercard, Mada), Fawry, Meeza, bank transfer, and Apple Pay. You can choose monthly or annual billing. Annual subscriptions save you 2 full months (pay 10 months, get 12).',
                'display_order' => 9,
            ],
            // ─── Phase F — new pricing FAQs for the launch tier model ───
            [
                'category' => 'pricing',
                'question_ar' => 'هل توجد رسوم تركيب أو إعداد؟',
                'question_en' => 'Are there setup or onboarding fees?',
                'answer_ar' => 'باقتا Starter و Growth: التركيب وترحيل البيانات مجاني تمامًا — بدون أي رسوم إضافية. باقة Professional: رسوم تركيب اختيارية (7,500 ج.م مرة واحدة) للحصول على خدمة White-glove تشمل ترحيل البيانات الكامل، تدريب الفريق، تخصيص القوالب الطبية، وإعداد التكاملات. Enterprise: حسب الحجم — تواصل مع المبيعات.',
                'answer_en' => 'Starter and Growth plans: setup and data migration are completely free — no extra fees. Professional plan: optional 7,500 EGP one-time white-glove setup covering full data migration, team training, custom medical templates, and integration configuration. Enterprise: scoped to your size — talk to sales.',
                'display_order' => 11,
            ],
            [
                'category' => 'pricing',
                'question_ar' => 'كيف يعمل التسعير لكل طبيب إضافي؟',
                'question_en' => 'How does per-doctor pricing work?',
                'answer_ar' => 'في باقات Growth و Professional، طبيب واحد مشمول في السعر الأساسي. كل طبيب إضافي يضيف 700 ج.م/شهر (Growth) أو 900 ج.م/شهر (Professional). هذا يضمن أن العيادة الفردية تدخل بسعر منخفض، والعيادة الأكبر تدفع بشكل عادل حسب حجم فريقها الفعلي. باقة Starter للطبيب الفرد فقط، و Enterprise بدون حدود مع تسعير مخصص.',
                'answer_en' => 'Growth and Professional plans include 1 doctor in the base price. Each additional doctor adds 700 EGP/mo (Growth) or 900 EGP/mo (Professional). This ensures solo practitioners enter at a low price while larger clinics pay fairly based on actual team size. Starter is solo-only, and Enterprise has no doctor limits with custom pricing.',
                'display_order' => 13,
            ],
            [
                'category' => 'pricing',
                ...
                'answer_ar' => 'Growth (3,990 ج.م/شهر) تشمل تخصص طبي واحد (تختار من 7)، طبيب مشمول + 700 ج.م لكل طبيب إضافي، حتى 2,000 مريض، CRM طبي، WhatsApp/Telemedicine كـ Add-ons، تقارير وأدوار صلاحيات. Professional (6,990 ج.م/شهر) تشمل 3 تخصصات، طبيب + 900 ج.م لكل إضافي، 10,000 مريض، WhatsApp و Telemedicine و Lab مجانًا، HR + رواتب، تكامل تأمين، API، ودعم بأولوية (بريد + هاتف). الترقية تصبح مربحة بمجرد إدارة أكثر من تخصص واحد أو الحاجة للتأمين أو التطبيب عن بُعد.',
                'answer_en' => 'Growth (3,990 EGP/mo) includes 1 specialty (pick from 7), 1 doctor + 700 EGP per extra doctor, up to 2,000 patients, medical CRM, WhatsApp/Telemedicine as add-ons, reports and roles. Professional (6,990 EGP/mo) includes 3 specialties, 1 doctor + 900 EGP per extra, 10,000 patients, free WhatsApp, Telemedicine and Lab integrations, HR + payroll, insurance module, API, and priority email + phone support. The upgrade pays back as soon as you run more than one specialty or need insurance/telemedicine.',
                'display_order' => 14,
            ],
            [
                'category' => 'pricing',
