        ...
        $plans = [
            ...
            [
                ...
                'features_ar' => [
                    ...
                    'مرضى غير محدودين',
                    'خدمة الاستشارات الأون لاين (مكالمات فيديو HD + وصفات إلكترونية)',
                ...
                'features_en' => [
                    ...
                    'Unlimited patients',
                    'Online consultations service (HD video + e-prescriptions)',
                ...
                'modules_included' => ['patients','bookings','invoices','payments','website','crm','wallet','discounts','chat','notifications','prescriptions','satisfaction','expenses','telemedicine'],
                'max_users' => 10,
                'max_patients' => null,
                'support_level' => 'phone',
                'display_order' => 2,
            ...
            [
                ...
                'features_ar' => [
                    ...
                    'الاستشارات الأون لاين الكاملة (عدد لا محدود + تسجيل الجلسات + تحليلات)',
                    'وحدة طب الأطفال الكاملة (مخططات نمو WHO + جدول تطعيمات + بروتوكولات)',
                ...
                'features_en' => [
                    ...
                    'Full online consultations (unlimited + session recording + analytics)',
                    'Complete Pediatrics module (WHO growth charts + vaccination schedule + protocols)',
                ...
                'modules_included' => ['patients','bookings','invoices','payments','website','crm','wallet','discounts','chat','notifications','prescriptions','satisfaction','expenses','dental','pediatrics','telemedicine','hr','insurance','inventory','webmaster','rbac','audit'],
                'max_users' => null,
                'max_patients' => null,
