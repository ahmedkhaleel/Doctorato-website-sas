...
/**
 * Doctorato add-ons — May 2026 RESET.
 *
 * Post-reset: launch pricing decommissioned. One real price per add-on.
 * Add-ons bundled FREE on Professional + Enterprise via included_in_plans
 * so those tiers feel genuinely all-inclusive.
 *
 * is_launch_active is forced to false everywhere — the field is kept on
 * the model only so old data deserializes cleanly. activePrice() falls
 * back to price_egp.
 */
    ...
    public function run(): void
    {
        $items = [
            [
                ...
                'price_egp' => 700, 'price_egp_launch' => null, 'is_launch_active' => false,
            ...
            [
                'name_ar' => 'باقة SMS — 500 رسالة',
                'name_en' => 'SMS pack — 500 messages',
                'description_ar' => '500 رسالة SMS شهرياً للتذكيرات والتأكيدات والحملات',
                'description_en' => '500 SMS messages per month for reminders, confirmations, campaigns',
            ...
            [
                ...
                'price_egp' => 790, 'price_egp_launch' => null, 'is_launch_active' => false,
